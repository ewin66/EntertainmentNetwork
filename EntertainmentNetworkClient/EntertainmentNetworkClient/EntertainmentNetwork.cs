...
{
    public partial class EntertainmentNetwork : Form
    {
        public EntertainmentNetwork()
        {
            InitializeComponent();
        ...
        {
            Type moduleType = typeof(EntertainmentNetwork).Assembly.GetType(e.Document.ControlTypeName);
