...
@WebService(serviceName="MyWebService", endpointInterface="isd.dp.ua.EntertainmentNetworkServer.Common.ICrudOperations")
@Service
public class CityService extends BaseModelService<City>
{	
	@Autowired
	public CityService(@Qualifier("cityDao") ICrudOperations<City> daoOperations)
	{
		super(daoOperations);
	}
}
